                ...
                <td>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('view',$brg->id)}}" class="btn bg-danger rounded-circle" style="width:70px;"><img src="{{asset('aset/img/shop.png')}}" class="mx-auto d-block" alt="" style="width: 40px; margin-right:10px;"></a>
                        </div>
                        </div>
                    </div>
                    </div>
